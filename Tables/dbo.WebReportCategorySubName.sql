...
GO
ALTER TABLE [dbo].[WebReportCategorySubName] ADD CONSTRAINT [FK_WebReportCategorySubName_Language] FOREIGN KEY ([LanguageID]) REFERENCES [dbo].[Language] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
