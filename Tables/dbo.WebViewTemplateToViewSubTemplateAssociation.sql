...
[WebViewToViewSubAssociationID] [uniqueidentifier] NOT NULL,
...
GO
ALTER TABLE [dbo].[WebViewTemplateToViewSubTemplateAssociation] ADD CONSTRAINT [FK_WebViewTemplateToViewSubTemplateAssociation_WebViewToViewSubAssociation] FOREIGN KEY ([WebViewToViewSubAssociationID]) REFERENCES [dbo].[WebViewToViewSubAssociation] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
