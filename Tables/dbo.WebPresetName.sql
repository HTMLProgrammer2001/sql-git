...
GO
ALTER TABLE [dbo].[WebPresetName] ADD CONSTRAINT [FK_WebPresetName_Language] FOREIGN KEY ([LanguageID]) REFERENCES [dbo].[Language] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[WebPresetName] ADD CONSTRAINT [FK_WebPresetName_WebPreset] FOREIGN KEY ([WebPresetID]) REFERENCES [dbo].[WebPreset] ([ID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
