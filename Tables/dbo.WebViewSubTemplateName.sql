...
GO
ALTER TABLE [dbo].[WebViewSubTemplateName] ADD CONSTRAINT [FK_WebViewSubTemplateName_WebViewSubTemplate] FOREIGN KEY ([WebViewSubTemplateID]) REFERENCES [dbo].[WebViewSubTemplate] ([ID]) ON DELETE CASCADE
GO
