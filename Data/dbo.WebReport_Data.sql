INSERT INTO [dbo].[WebReport] ([ID], [WebReportCategoryID], [WebReportCategorySubID], [Name], [Code], [Rdl], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [LanguageID], [CreateDate]) VALUES ('a9b155c3-c559-ed11-8e5e-4ccc6a2bb6d6', '296c565d-433e-ed11-8e5b-4ccc6a2bb6d6', NULL, N'Transactions Report', N'TranRep', N'<?xml version="1.0" encoding="utf-8"?>
                        ...
                        <Textbox Name="TextBox7">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>Transaction Qty/number </Value>
                                  <Style>
                                    <FontFamily>Arial</FontFamily>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="TextBox14">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>Total before discount </Value>
                                  <Style>
                                    <FontFamily>Arial</FontFamily>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="TextBox70">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!AmountBeforeDid.Value</Value>
                                  <Style>
                                    <FontFamily>Arial</FontFamily>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="TextBox71">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!DiscountPer.Value</Value>
                                  <Style>
                                    <FontFamily>Arial</FontFamily>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="TextBox76">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!ReturnsPer.Value</Value>
                                  <Style>
                                    <FontFamily>Arial</FontFamily>
                                  </Style>
                                </TextRun>
            ...
            <TablixRowHierarchy>
              <TablixMembers>
                ...
                <TablixMember>
                  ...
                  <Visibility>
                    <Hidden>False</Hidden>
                    <ToggleItem>Company21</ToggleItem>
                  </Visibility>
                </TablixMember>
              </TablixMembers>
            </TablixRowHierarchy>
...
SELECT c.Code+ '' '' + c.DisplayName [Company], s.DisplayName [Store], t.TransactionNumber, SUM(ti.Amount) [AmountBeforeDid], 
CASE WHEN SUM(ti.Amount) &lt;&gt; 0 then 100-(SUM(ti.Amount)+SUM(ti.Discount))/SUM(ti.Amount)*100 else 0 end [DiscountPer], SUM(ti.Amount+ti.Discount) [Amount], 
SUM(ti.Quantity) [Quantity], ((CAST(cr.CountReturns AS numeric(15,4))/CAST(cs.CountSales AS numeric(15,4)))*100) [ReturnsPer]
...
INNER JOIN (
	SELECT Count(t.TransactionNumber) as CountSales FROM dbo.[Transaction] t
	INNER JOIN dbo.Location l ON t.LocationID=l.ID  and t.TransactionTypeID=2 and CAST(TransactionDate as Date) between @DateFrom and @DateTo
	INNER JOIN dbo.Store s ON s.ID=l.StoreID
	--WHERE s.ID IN (@DataStore)
	) as cs ON 1=1
INNER JOIN (
	SELECT Count(t.TransactionNumber) as CountReturns FROM dbo.[Transaction] t
	INNER JOIN dbo.Location l ON t.LocationID=l.ID  and t.TransactionTypeID=6 and CAST(TransactionDate as Date) between @DateFrom and @DateTo
	INNER JOIN dbo.Store s ON s.ID=l.StoreID
	--WHERE s.ID IN (@DataStore)
	) as cr ON 1=1
--WHERE s.ID IN (@DataStore) 
GROUP BY c.Code+ '' '' + c.DisplayName, s.DisplayName, t.TransactionNumber,cr.CountReturns,cs.CountSales
having SUM(ti.Quantity) &lt;&gt; 0</CommandText>
      ...
      <Fields>
        ...
        <Field Name="AmountBeforeDid">
          <DataField>AmountBeforeDid</DataField>
        ...
        <Field Name="ReturnsPer">
          <DataField>ReturnsPer</DataField>
          <rd:TypeName>System.Decimal</rd:TypeName>
        </Field>
      </Fields>
    </DataSet>
...
Select @DateFrom [DateFrom],  @DateTo [DateTo]</CommandText>
  ...
  <ReportParameters>
    ...
    <ReportParameter Name="MinAmount">
      <DataType>Integer</DataType>
      <Prompt>Minimum amount</Prompt>
      <Nullable>true</Nullable>
    </ReportParameter>
    <ReportParameter Name="MaxAmount">
      <DataType>Integer</DataType>
      <Prompt>Maximum amount</Prompt>
      <Nullable>true</Nullable>
    </ReportParameter>
    <ReportParameter Name="TranType">
      <DataType>Integer</DataType>
    ...
    <GridLayoutDefinition>
      ...
      <CellDefinitions>
        ...
        <CellDefinition>
          <ColumnIndex>2</ColumnIndex>
          <RowIndex>2</RowIndex>
          <ParameterName>TranType</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>3</RowIndex>
...
</Report>', '2022-11-02 11:45:32.6666667 +00:00', 19, N'N', 'cbeca1c2-2836-4b43-bcca-059deb1e7c97', 1, NULL, 2, '2022-11-01 11:15:44.8955945 +02:00')
INSERT INTO [dbo].[WebReport] ([ID], [WebReportCategoryID], [WebReportCategorySubID], [Name], [Code], [Rdl], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [LanguageID], [CreateDate]) VALUES ('aab155c3-c559-ed11-8e5e-4ccc6a2bb6d6', '296c565d-433e-ed11-8e5b-4ccc6a2bb6d6', NULL, N'Transactions Report', N'TranRep', N'<?xml version="1.0" encoding="utf-8"?>
<Report xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner" xmlns:df="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition/defaultfontfamily" xmlns="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition">
  <ReportSections>
    <ReportSection>
      <Body>
  ...
  <rd:PageUnit>Px</rd:PageUnit>
  <df:DefaultFontFamily>Segoe UI</df:DefaultFontFamily>
</Report>', '2022-11-01 11:57:25.0833333 +00:00', 2, N'Y', '68b104f8-1a7a-4c77-9b77-9268ae95012b', 1, NULL, 2, '2022-11-01 11:15:44.8955945 +02:00')
        ...
        <ReportItems>
          ...
          <Tablix Name="Tablix2">
            ...
            <TablixBody>
              <TablixColumns>
                <TablixColumn>
                  <Width>85.00781pt</Width>
                </TablixColumn>
                <TablixColumn>
                  <Width>84.25781pt</Width>
                </TablixColumn>
                <TablixColumn>
                  <Width>80.50781pt</Width>
                </TablixColumn>
                <TablixColumn>
                  <Width>76.00781pt</Width>
                </TablixColumn>
                <TablixColumn>
                  <Width>69.75pt</Width>
                </TablixColumn>
                <TablixColumn>
                  <Width>78.05859pt</Width>
                </TablixColumn>
              </TablixColumns>
              <TablixRows>
                <TablixRow>
            ...
            <TablixRowHierarchy>
              <TablixMembers>
                <TablixMember>
                  <TablixHeader>
                    <Size>88.75781pt</Size>
                    <CellContents>
                      <Textbox Name="TextBox241">
                        <Left>0in</Left>
                        <Top>0in</Top>
                        <Height>18pt</Height>
                        <Width>88.75781pt</Width>
                        <Style>
                          <BackgroundColor>#e3e3e3</BackgroundColor>
                          <FontFamily>Arial</FontFamily>
                          <PaddingLeft>2pt</PaddingLeft>
          ...
          <Tablix Name="TableHierarchy">
            ...
            <TablixRowHierarchy>
              <TablixMembers>
                <TablixMember>
                  <TablixHeader>
                    <Size>74.22656pt</Size>
                    <CellContents>
                      <Textbox Name="TextBox631">
                        <Left>0in</Left>
                        <Top>0in</Top>
                        <Height>18pt</Height>
                        <Width>74.22656pt</Width>
                        <Style>
                          <BackgroundColor>#e3e3e3</BackgroundColor>
                          <FontFamily>Arial</FontFamily>
                          <PaddingLeft>2pt</PaddingLeft>
                ...
                <TablixMember>
                  <TablixHeader>
                    <Size>148.45312pt</Size>
                    <CellContents>
                      <Textbox Name="TextBox611111112">
                        <Left>0in</Left>
                        <Top>0in</Top>
                        <Height>18pt</Height>
                        <Width>148.45312pt</Width>
                        <Style>
                          <BackgroundColor>#e3e3e3</BackgroundColor>
                          <FontFamily>Arial</FontFamily>
                          <PaddingLeft>2pt</PaddingLeft>
...
select Id,DisplayName + '' '' from ItemHierarchy1</CommandText>
    ...
    <DataSet Name="Hierarchy2">
      <Query>
        ...
        <CommandText>select -2 id, ''Not selected'' DisplayName
UNION ALL
select Id,DisplayName + '' '' from ItemHierarchy2</CommandText>
      </Query>
      <Fields>
        <Field Name="id">
          <DataField>id</DataField>
    ...
    <DataSet Name="Hierarchy3">
      <Query>
        ...
        <CommandText>select -2 id, ''Not selected'' DisplayName
UNION ALL
select Id,DisplayName + '' '' from ItemHierarchy3</CommandText>
      </Query>
      <Fields>
        <Field Name="id">
          <DataField>id</DataField>
    ...
    <DataSet Name="Hierarchy4">
      <Query>
        ...
        <CommandText>select -2 id, ''Not selected'' DisplayName
UNION ALL
select Id,DisplayName + '' '' from ItemHierarchy4</CommandText>
      </Query>
      <Fields>
        <Field Name="id">
          <DataField>id</DataField>
    ...
    <DataSet Name="Hierarchy5">
      <Query>
        ...
        <CommandText>select -2 id, ''Not selected'' DisplayName
UNION ALL
select Id,DisplayName + '' '' from ItemHierarchy5</CommandText>
      </Query>
      <Fields>
        <Field Name="id">
          <DataField>id</DataField>
  ...
  <rd:PageUnit>Px</rd:PageUnit>
  <df:DefaultFontFamily>Segoe UI</df:DefaultFontFamily>
</Report>', '2022-11-01 12:13:35.2166667 +00:00', 238, N'N', '38f70520-5252-4309-9a17-c9438f84e355', 1, NULL, 2, '2022-09-28 17:31:50.1416447 +03:00')
