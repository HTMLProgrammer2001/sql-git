...
INSERT INTO [dbo].[WebViewSub] ([ID], [Name], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [ComponentHtml], [Code], [CreateDate]) VALUES (2, N'Manage partner group', '2022-07-15 17:52:50.8466667 +00:00', 4, N'N', 'deae29d9-a777-4f57-9eb6-83ebf1578a42', 1, NULL, N'<cr-partner-group-manage-dynamic
    [subTemplateId]="{{subTemplateId}}"
...
INSERT INTO [dbo].[WebViewSub] ([ID], [Name], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [ComponentHtml], [Code], [CreateDate]) VALUES (3, N'Manage partner addresses', '2022-07-15 18:27:49.0133333 +00:00', 5, N'N', 'c1af0a03-9e83-49b4-ab9d-d3e39b3f692f', 1, NULL, N'<cr-addresses-details-dynamic
...
INSERT INTO [dbo].[WebViewSub] ([ID], [Name], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [ComponentHtml], [Code], [CreateDate]) VALUES (4, N'Create partner addresses', '2022-07-15 18:30:08.0566667 +00:00', 2, N'Y', '72a20b70-7366-4f91-9da6-ba776183c556', 1, NULL, N'<cr-addresses-details-dynamic
    [subTemplateId]="{{subTemplateId}}"
    (closeClickEvent)="self.onClosePartnerAddresses()"
    [isNew]="true"
    [itemAddress]="self.partnerDetailsAddress"
...
INSERT INTO [dbo].[WebViewSub] ([ID], [Name], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [ComponentHtml], [Code], [CreateDate]) VALUES (10004, N'Manage partner contact person', '2022-07-15 18:54:23.1500000 +00:00', 3, N'Y', '78c219a1-8bc4-4214-a152-14cb6eac1990', 1, NULL, N'<cr-partner-contact-persons-details
    [subTemplateId]="{{subTemplateId}}"
    [isNew]="false"
...
INSERT INTO [dbo].[WebViewSub] ([ID], [Name], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [ComponentHtml], [Code], [CreateDate]) VALUES (10005, N'Manage partner contact persons list', '2022-07-15 18:59:08.2200000 +00:00', 3, N'N', '6ac5d4b7-5294-4849-b4f6-877123e7f40d', 1, NULL, N'<cr-partner-contact-persons-details
    *ngIf="self.popupTab.tabs[self.popupTab.activeTabIndex].details === ''edit''"
    [subTemplateId]="{{subTemplateId}}"
    (openMailingCategory)="self.onEditContactPersonMailingCategory()"
    (closeClickEvent)="self.onClosePartnerContactPersons()"
