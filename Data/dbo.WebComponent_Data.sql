...
INSERT INTO [dbo].[WebComponent] ([ID], [WebIconSvgEnumID], [Code], [Name], [Title], [ComponentHtml], [ComponentFormBuilderHtml], [ComponentPreviewHtml], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [CreateDate]) VALUES (9, 'e3b4ef1c-e343-ed11-8e5c-4ccc6a2bb6d6', N'checkbox-form-element', N'DONT TOUCH. Checkbox', N'DONT TOUCH. Checkbox', N'', N'<div *ngIf="self.settings?.is">
    <cr-checkbox-control 
        [dataLabel]="!self.settings.isUseTranslateKey ? self.currentText : null"
        [translateKeys]="self.settings.isUseTranslateKey ? self.settings.translateKey : null"
        [isDisabled]="self.settings.isDisabled"
...
INSERT INTO [dbo].[WebComponent] ([ID], [WebIconSvgEnumID], [Code], [Name], [Title], [ComponentHtml], [ComponentFormBuilderHtml], [ComponentPreviewHtml], [UpdateDate], [Version], [IsDeleted], [GUID], [AppType], [UpdateUser], [CreateDate]) VALUES (11, 'e6b4ef1c-e343-ed11-8e5c-4ccc6a2bb6d6', N'button-form-element', N'DONT TOUCH. Button', N'DONT TOUCH. Button', N'test', N'<div *ngIf="self.settings?.is">
      <cr-button-control
